...
<div class="sidebar-wrapper" id="sidebar">
    ...
    <div class="sidebar">
        ...
        <h4></h4>
        <ul class="list-group">
            <li class="list-group-item {{ request()->is('dosen') ? 'active' : '' }}">
                <a href="{{ url('/dosen') }}">Beranda</a>
            </li>
            <li class="list-group-item {{ request()->is('pinjambarang', 'pinjambarang-tambah/*') ? 'active' : '' }}">
                <a href="{{ url('/pinjambarang') }}">Pinjaman</a>
            </li>
            <li class="list-group-item {{ request()->is('keluhandosen') ? 'active' : '' }}">
                <a href="{{ url('/keluhandosen') }}">keluhan</a>
            </li>
        </ul>
