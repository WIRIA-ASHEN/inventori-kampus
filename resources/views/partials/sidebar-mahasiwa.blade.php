...
<div class="sidebar-wrapper" id="sidebar">
    ...
    <div class="sidebar">
        ...
        <h4></h4>
        <ul class="list-group">
            <li class="list-group-item {{ request()->is('mahasiswa') ? 'active' : '' }}">
                <a href="{{ url('/mahasiswa') }}">Beranda</a>
            </li>
            <li class="list-group-item {{ request()->is('pinjambarang-mahasiswa', 'pinjambarang-tambahmahasiswa/*') ? 'active' : '' }}">
                <a href="{{ url('/pinjambarang-mahasiswa') }}">Pinjaman</a>
            </li>
            <li class="list-group-item {{ request()->is('keluhan') ? 'active' : '' }}">
                <a href="{{ url('/keluhan') }}">Keluhan</a>
            </li>
        </ul>
